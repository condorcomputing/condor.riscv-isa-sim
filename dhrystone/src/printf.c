...
// -----------------------------------------------------------------------
int CONDOR_PRINTF(const char* format, ...)
{
  va_list ap;
...
#endif
// endif of CONDOR_NO_PRINTF

// -----------------------------------------------------------------------
// LMZ - Whisper is having a hard time with cssr instruction so I 
// am going to comment it out
//
// Function to read cpu mcycle csr for 
// performance measurements simplified version
// -----------------------------------------------------------------------
#ifdef CONDOR_DRY_MCYCLE
uint64_t get_mcycle(){
  return 0x1000ULL;
}
//#warning "Using static constant for get_mcycle() in printf.c"
#endif
