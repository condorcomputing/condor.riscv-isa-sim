...
To clone:
```
git clone https://github.com/jeffnye-gh/cpm.riscv-isa-sim.git --recurse-submodules
```
...
See : [USAGE.md](https://github.com/jeffnye-gh/cpm.riscv-isa-sim/blob/spike_stf/USAGE.md)
